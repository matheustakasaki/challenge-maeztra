...
export default function Slider({ slides }) {
    ...
    return (
        ...
        <div className={`bg-[url(${slides[currentIndex].imageUrl})] bg-no-repeat bg-cover bg-center flex min-h-[20rem]`}>

            <svg onClick={goToPrevious} width="20" height="32" viewBox="0 0 20 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
                ...
                <p className='text-sm'>{slides[currentIndex].subHeading}</p>
            ...
            <svg onClick={goToNext} width="20" height="32" viewBox="0 0 20 32" fill="none" xmlns="http://www.w3.org/2000/svg">
